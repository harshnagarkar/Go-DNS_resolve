...
* **Conditional Variables**: Implement your synchronization protections using POXIX conditional variables. You have to submit the original project working with mutexes or semaphores to get credit for this or any of the extra credit.
